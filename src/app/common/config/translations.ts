const translations = {
  ...
  OPERATOR: {
    REGISTER: {
      ...
      DESCRIPTION: 'Register to the networks registry to enable others to discover and select you as one of their validator’s operators.',
      OPERATOR_EXIST_ERROR: 'Operator key has already been registered.',
    },
    CONFIRMATION: {
    ...
    HOME: {
      ...
      TOOLTIP: "Operators identifier in the SSV network. To generate your key see our <a herf='www.google.com'>documentation.</a>",
