...
const Routes: any = () => {
    ...
    const dashboardRoutes = [
        ...
        { path: ssvRoutes.MY_ACCOUNT.OPERATOR.OPERATOR_UPDATE_FEE, component: UpdateFee },
        { path: ssvRoutes.MY_ACCOUNT.OPERATOR.REMOVE_OPERATOR, component: RemoveOperator },
        { path: ssvRoutes.MY_ACCOUNT.CONFIRM_OPERATORS, component: ConfirmOperatorsChange },
        { path: ssvRoutes.MY_ACCOUNT.OPERATOR.OPERATOR_REMOVED, component: OperatorRemoved },
