      ...
      <BorderScreen
        ...
        body={[
          <Grid container className={classes.Wrapper}>
            ...
            />
            <PrimaryButton wrapperClass={classes.SubmitButton} text={buttonText} submitFunction={requestForSSV} disable={walletStore.wrongNetwork || disabled || reachedMaxTransactionPerDay}
