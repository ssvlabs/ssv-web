...
const ChangeFee = ({ inputValue, onChangeHandler = () => null, error, nextIsDisabled, onNextHandler }: ChangeFeeProps) => {
        ...
        <BorderScreen
            ...
            body={[
                <Grid container className={classes.ChangeFeeWrapper}>
                    ...
                    <ConversionInput value={inputValue} onChange={onChangeHandler} error={error}/>
