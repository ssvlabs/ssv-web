...
export const useStyles = makeStyles((theme: Theme) => ({
  ...
  ProgressBarText: {
    ...
    '&:nth-child(1)': {
      fontWeight: (props: any) =>
        props.step === StepperSteps.DECLARE_FEE ? 800 : 500,
      color: (props: any) =>
        props.step === StepperSteps.DECLARE_FEE
          ? theme.colors.gray80
          : theme.colors.gray60
    },
    '&:nth-child(2)': {
      fontWeight: (props: any) =>
        props.step === StepperSteps.WAITING ? 800 : 500,
      color: (props: any) =>
        props.step === StepperSteps.WAITING
          ? theme.colors.gray80
          : theme.colors.gray60
    },
    '&:nth-child(3)': {
      fontWeight: (props: any) =>
        props.step === StepperSteps.EXECUTION ? 800 : 500,
      color: (props: any) =>
        props.step === StepperSteps.EXECUTION
          ? theme.colors.gray80
          : theme.colors.gray60
    },
    '&:nth-child(4)': {
  ...
  StepWrapper: {
    ...
    '&:nth-of-type(1)': {
      border: (props: any) => {
        return props.step === StepperSteps.DECLARE_FEE
          ? `3px solid ${theme.colors.primaryBlue}`
          : 'none';
      },
