...
const ConfirmationStep = ({
  ...
  const [isSelectedCheckboxes, setIsSelectedCheckboxes] = useState(
    initialState(checkBoxes)
  );
  const disableCButtonCondition = isSelectedCheckboxes.some(
  ...
  const Button =
    currentBulkFlow === BULK_FLOWS.BULK_REMOVE ? ErrorButton : PrimaryButton;
