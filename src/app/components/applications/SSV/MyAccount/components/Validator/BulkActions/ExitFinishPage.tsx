    ...
    <ExitWrapper>
      <Exit>
        ...
        <ExitText>
          ...
          Once your validator has fully exited, you can remove it from the SSV
          Network. Keep in mind that you will continue to incur operational fees
          until it's removed, regardless of the validator's state on the Beacon
          Chain.
        </ExitText>
        <PrimaryButton
          text={'Go to Cluster Page'}
          onClick={nextStep}
          size={ButtonSize.XL}
        />
      </Exit>
