...
import CancelUpdateFee
  from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/CancelUpdateFee';
import {
  useStyles,
} from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/UpdateFee/UpdateFee.styles';
import DeclareFee
  from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/UpdateFee/components/DeclareFee';
import FeeUpdated
  from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/UpdateFee/components/FeeUpdated';
import WaitingPeriod
  from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/UpdateFee/components/WaitingPeriod';
import PendingExpired
  from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/UpdateFee/components/PendingExpired';
import PendingExecution
  from '~app/components/applications/SSV/NewMyAccount/components/EditFeeFlow/UpdateFee/components/PendingExecution';
