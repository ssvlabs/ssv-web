        ...
        <div className="flex flex-col gap-8 w-full">
          <div className="flex flex-col gap-4">
            ...
            <p className="font-medium text-sm =">
              ...
              <br />
              In public mode, any validator can register with the operator, while in private mode, only authorized addresses can register.
              <br />
              <br />
              Please note that switching to Private only impacts future validator registrations and will not disrupt the functionality of already registered validators in clusters
              that include this Operator.
            </p>
          </div>
