      ...
      body={[
        <Grid container>
          <HeaderSubHeader
            ...
            subtitle={
              'To join as an network operator, you must run an SSV node. Start with your node setup and return here to register your operator key.'
            }
          />
          <Grid container item>
              ...
              <Grid item xs={12}>
                <SecondaryButton
                  ...
                  onClick={() => {
                    ...
                    window.open(
                      'https://docs.ssv.network/run-a-node/operator-node/installation'
                    );
                  }}
                  size={ButtonSize.XL}
                />
