    ...
    <BorderScreen
      ...
      body={[
        <Grid container spacing={6}>
          ...
          <Grid item className={classes.Text} xs={12}>
            If you have deposited your validator recently, keep in mind that it
            could take up to ~24 hours until it is picked up by the Beacon
            Chain.
          </Grid>
          <Grid item className={classes.Text} xs={12}>
            ...
            >
              <Typography
                noWrap
              >{`${getBeaconChainLink()}/validator/${validatorStore.keyStorePublicKey}`}</Typography>
            </Link>
          </Grid>

          <Grid item className={classes.Text} xs={12}>
            If you haven&apos;t deposited your validator yet, follow
            Ethereum&apos;s launchpad instructions to deposit your validator to
