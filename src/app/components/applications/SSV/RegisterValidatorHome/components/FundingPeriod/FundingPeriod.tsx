...
const FundingPeriod = () => {
  ...
  const timePeriodNotValid =
    customPeriod < config.GLOBAL_VARIABLE.CLUSTER_VALIDITY_PERIOD_MINIMUM;
  ...
  const totalAmount = formatNumberToUi(
    Number(totalCost.mul(validatorStore.validatorsCount).toFixed(18))
  );
      ...
      body={[
        <Grid container>
          <Typography className={classes.Text}>
            ...
            runway <br />
            (You can always manage it later by withdrawing or depositing more
            funds).
          </Typography>
