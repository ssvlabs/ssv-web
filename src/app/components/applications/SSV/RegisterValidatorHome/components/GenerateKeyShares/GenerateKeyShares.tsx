...
import useValidatorRegistrationFlow, {
  ...
  const buttonsData: ButtonData[] = [
    ...
    },
    {
      ...
      buttonProps: {
        ...
        text: translations.VALIDATOR.GENERATE_KEY_SHARES
          .ALREADY_HAVE_KEY_SHARES,
        onClick: () => {
          validatorStore.keyStoreFile = null;
      ...
      body={[
        <Grid container style={{ gap: 24 }}>
          <HeaderSubHeader
            marginBottom={0.01}
            title={
              translations.VALIDATOR.GENERATE_KEY_SHARES.GENERATE_KEY_SHARES
            }
            subtitle={
              <>
                To run a Distributed Validator you must split your validation
                key into <br />
