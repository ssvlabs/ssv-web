...
const ValidatorCounter = ({
  ...
  return (
    <Grid className={classes.ValidatorCounterWrapper}>
      <Grid onClick={decreaseCount} className={`${classes.CounterButton} ${reachedMinCount && classes.DisabledButton}`}>
        <Grid className={`${classes.MinusIcon} ${reachedMinCount && classes.DisabledMinus}`} />
      </Grid>
      ...
      <Grid onClick={increaseCount} className={`${classes.CounterButton} ${reachedMaxCount && classes.DisabledButton}`}>
        <Grid className={`${classes.PlusIcon} ${reachedMaxCount && classes.DisabledPlus}`} />
      </Grid>
    </Grid>
  );
};
