  ...
  return (
    ...
    >
      <Grid className={classes.ValidatorKeyWrapper}>
        ...
        <ImageDiv
          onClick={() => copyToClipboard(validatorPublicKey)}
          image={'copy'}
          width={24}
          height={24}
        />
        <ImageDiv
          onClick={() => openBeaconcha(validatorPublicKey)}
          image={'beacon'}
          width={24}
          height={24}
        />
      ...
      {errorMessage && (
        <Grid className={classes.ErrorBadge}>{errorMessage}</Grid>
      )}
      {registered && (
        <Grid className={classes.RegisteredBadge}>Registered</Grid>
      )}
    </Grid>
  );
};
