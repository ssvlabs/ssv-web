...
const OfflineKeyShareCeremony = () => {
  ...
  return (
    <Grid container className={classes.CeremonyContainerWrapper}>
        ...
        <Grid container item className={classes.DkgInstructionsWrapper}>
          <Grid className={classes.StepAndBadgeWrapper}>
            ...
            <Grid className={classes.CompletedBadge}>
              <Typography className={classes.CompletedBadgeText}>
                Completed
              </Typography>
          ...
          <Grid className={classes.DkgNotification}>
            ...
            <Grid>
              ...
              <Typography className={classes.DkgCodeText}>
                This file contains the signatures indicating that the ceremony
                was conducted by the cluster operators and is{' '}
                <BoldText>crucial for resharing</BoldText> your validator with a
                different set of operators in the future. Please ensure to{' '}
                <BoldText>back up</BoldText> this file securely.
              </Typography>
            </Grid>
            <Grid className={classes.Line} />
            <Typography className={classes.DkgCodeText}>
              For ceremonies generating more than one validator, you will find
              aggregated versions of all the previously mentioned files within
              the <DirectoryBadge directoryPath={'ceremony-[timestamp]'} />{' '}
              folder.
            </Typography>
          </Grid>
        </Grid>
      ...
      <Grid
        className={`${classes.TitleBox} ${!isValidatorActivated ? classes.SelectedBoxBorder : null}`}
      >
        <Grid container item className={classes.DkgInstructionsWrapper}>
          <Grid className={classes.StepAndBadgeWrapper}>
            <Typography className={classes.DkgTitle}>
          ...
          <Grid className={classes.DkgText}>
            ...
            &nbsp;or refer to the{' '}
            <LinkText
              text={'validator activation'}
              link={
                'https://docs.ssv.network/validator-user-guides/validator-management/creating-a-new-validator#activate-validator-keys'
              }
            />
            &nbsp;guide for assistance.
          </Grid>
          <PrimaryButton
            text={'My validator has been activated'}
            onClick={handleValidatorActivatedClick}
            isDisabled={isValidatorActivated}
            size={ButtonSize.XL}
          />
        </Grid>
      </Grid>
      ...
      >
        <Grid container item className={classes.DkgInstructionsWrapper}>
          ...
          <PrimaryButton
            text={'Register Validator'}
            onClick={goToNextPage[`${processStore.secondRegistration}`]}
            isDisabled={!isValidatorActivated}
            size={ButtonSize.XL}
          />
        </Grid>
