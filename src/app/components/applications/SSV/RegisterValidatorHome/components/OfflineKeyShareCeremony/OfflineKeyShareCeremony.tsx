        ...
        <Grid container item className={classes.DkgInstructionsWrapper}>
          ...
          <Grid className={classes.DkgNotification}>
            ...
            <Grid>
              ...
              <Typography className={classes.DkgCodeText}>This file contains the signatures indicating that the ceremony was conducted by the cluster operators and is crucial for resharing your validator with a different set of operators in the future. Please ensure to back up this file securely.</Typography>
            </Grid>
