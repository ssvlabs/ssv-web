...
const OfflineKeyShareCeremony = () => {
  ...
  return (
    <Grid container className={classes.CeremonyContainerWrapper}>
      ...
      <Grid className={classes.TitleBox}>DKG Ceremony Summary</Grid>
      <Grid className={classes.TitleBox}>
        <Grid container item className={classes.DkgInstructionsWrapper}>
          ...
          <Typography className={classes.DkgText}>
            ...
            <DirectoryBadge directoryPath={'ceremony-[timestamp]/[owner-nonce]-[validator-pubkey]'} />. folder under the directory the command was initiated:
          </Typography>
          <Grid className={classes.DkgNotification}>
            ...
            <Grid>
              <code className={classes.DkgCode}>keyshares.json</code>
            ...
            <Grid>
              ...
              <Typography className={classes.DkgCodeText}>
                This file contains the signatures indicating that the ceremony was conducted by the cluster operators and is <BoldText>crucial for resharing</BoldText> your
                validator with a different set of operators in the future. Please ensure to <BoldText>back up</BoldText> this file securely.
              </Typography>
            </Grid>
            <Grid className={classes.Line} />
            <Typography className={classes.DkgCodeText}>
              For ceremonies generating more than one validator, you will find aggregated versions of all the previously mentioned files within the{' '}
              <DirectoryBadge directoryPath={'ceremony-[timestamp]'} /> folder.
            </Typography>
          </Grid>
        </Grid>
      </Grid>
      <Grid className={`${classes.TitleBox} ${!isValidatorActivated ? classes.SelectedBoxBorder : null}`}>
        <Grid container item className={classes.DkgInstructionsWrapper}>
          ...
          <Grid className={classes.DkgText}>
            Activate your validator on the Beacon Chain by depositing 32 ETH into Ethereum's Deposit Contract. You can deposit your validator using{' '}
            <LinkText text={"Ethereum's LaunchPad"} link={getLaunchpadLink()} />
            &nbsp;or refer to the{' '}
            <LinkText text={'validator activation'} link={'https://docs.ssv.network/validator-user-guides/validator-management/creating-a-new-validator#activate-validator-keys'} />
            &nbsp;guide for assistance.
          </Grid>
          <PrimaryButton text={'My validator has been activated'} onClick={handleValidatorActivatedClick} isDisabled={isValidatorActivated} size={ButtonSize.XL} />
        </Grid>
      </Grid>
      <Grid className={`${classes.TitleBox} ${isValidatorActivated ? classes.SelectedBoxBorder : null}`}>
        <Grid container item className={classes.DkgInstructionsWrapper}>
