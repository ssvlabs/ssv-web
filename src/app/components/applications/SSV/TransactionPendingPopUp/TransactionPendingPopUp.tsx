...
const POP_UP_DATA = {
  ...
  true: {
    ...
    subTitles:
      'Your transaction has been successfully initiated within the multi-sig wallet and is now pending approval from other participants.'
  }
};
  ...
  return (
    ...
    >
      <GridWrapper container>
        ...
        <Grid item>
          <ImageWrapper
            src={'/images/ssv-loader.svg'}
            alt="loader"
            hasMarginBottom={!isContractWallet}
          />
        </Grid>
        {!isContractWallet && (
        ...
        {!isContractWallet && (
          <LinkText
            ...
            link={`${getEtherScanLink()}/tx/${txHash}`}
          />
        )}
      </GridWrapper>
    </DialogWrapper>
