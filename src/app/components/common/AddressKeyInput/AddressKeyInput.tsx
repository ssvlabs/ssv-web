...
const AddressKeyInput = ({
  address,
  withBeaconcha,
  withEtherScan,
  whiteBackgroundColor,
  withCopy
}: ValidatorPrivateKeyInputProps) => {
  ...
  return (
    ...
    >
      ...
      {withEtherScan && (
        <Grid item className={classes.EtherScanImage} onClick={openEtherScan} />
      )}
      {withBeaconcha && (
        <Grid item className={classes.BeaconImage} onClick={openBeaconcha} />
      )}
    </Grid>
  );
};
