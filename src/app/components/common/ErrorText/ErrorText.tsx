...
const ErrorText = (props: Props) => {
  ...
  const renderText = () => {
    if (errorType === ErrorType.WithdrawAll) {
      return (
        <div>
          Withdrawing the requested amount will liquidate your account, which will result in inactivation (
          <LinkText text={'penalties on the beacon chain'} link={'https://launchpad.ethereum.org/en/faq#responsibilities'} />) of your validators, as they will no longer be
