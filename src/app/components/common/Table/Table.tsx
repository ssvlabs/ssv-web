...
export const Table = ({
  ...
  disable?: boolean;
  hideActions?: boolean;
  actionProps?: PaginationActionParams;
}) => {
    ...
    <Grid container className={classes.TableWrapper}>
      ...
      {!hideActions && actionProps && actionProps.totalPages > 1 && (
        <PaginationActions
          ...
          onChangeRowsPerPage={(rowNumber: number) =>
            actionProps.onChangeRowsPerPage
              ? actionProps.onChangeRowsPerPage(actionProps.type, rowNumber)
              : null
          }
        />
      )}
