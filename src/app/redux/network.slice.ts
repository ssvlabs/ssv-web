...
export const fetchAndSetNetworkFeeAndLiquidationCollateral = createAsyncThunk(
  'network/fetchAndSetNetworkFeeAndLiquidationCollateral',
  async () => {
  ...
  extraReducers: (builder) => {
    builder.addCase(
      ...
      (
        ...
        state.liquidationCollateralPeriod =
          action.payload.liquidationCollateralPeriod;
        state.minimumLiquidationCollateral =
          action.payload.minimumLiquidationCollateral;
      }
    );
  }
});
