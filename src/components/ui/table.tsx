...
>(({ className, clickable, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "h-[52px] border-b border-b-gray-300 transition-colors bg-gray-50 hover:bg-gray-200 data-[state=selected]:bg-gray-300",
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-[52px] px-5 text-left align-middle font-medium [&:has([role=checkbox])]:pr-0 bg-white border-b border-gray-300",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "h-[52px] px-5 py-3 text-base font-medium align-middle [&:has([role=checkbox])]:pr-0 text-[14px]",
      className,
    )}
    {...props}
  />
