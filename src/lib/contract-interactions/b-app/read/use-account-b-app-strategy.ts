...
type Fn = ExtractAbiFunction<typeof BAppABI, "accountBAppStrategy">;
const abiFunction = extractAbiFunction(BAppABI, "accountBAppStrategy");

export const getAccountBAppStrategyQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "accountBAppStrategy",
...
export const fetchAccountBAppStrategy = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getAccountBAppStrategyQueryOptions(params));

export const useAccountBAppStrategy = (
  params: AbiInputsToParams<Fn["inputs"]>,
