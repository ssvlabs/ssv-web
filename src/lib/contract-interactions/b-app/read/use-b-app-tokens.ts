...
type Fn = ExtractAbiFunction<typeof BAppABI, "bAppTokens">;
const abiFunction = extractAbiFunction(BAppABI, "bAppTokens");

export const getBAppTokensQueryOptions = (
...
export const fetchBAppTokens = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getBAppTokensQueryOptions(params));

export const useBAppTokens = (
  params: AbiInputsToParams<Fn["inputs"]>,
