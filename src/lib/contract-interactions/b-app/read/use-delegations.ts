...
type Fn = ExtractAbiFunction<typeof BAppABI, "delegations">;
const abiFunction = extractAbiFunction(BAppABI, "delegations");

export const getDelegationsQueryOptions = (
...
export const fetchDelegations = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getDelegationsQueryOptions(params));
