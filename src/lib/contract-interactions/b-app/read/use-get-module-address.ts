...
type Fn = ExtractAbiFunction<typeof BAppABI, "getModuleAddress">;
const abiFunction = extractAbiFunction(BAppABI, "getModuleAddress");

export const getGetModuleAddressQueryOptions = (
...
export const fetchGetModuleAddress = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getGetModuleAddressQueryOptions(params));

export const useGetModuleAddress = (
  params: AbiInputsToParams<Fn["inputs"]>,
