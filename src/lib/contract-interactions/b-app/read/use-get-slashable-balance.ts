...
type Fn = ExtractAbiFunction<typeof BAppABI, "getSlashableBalance">;
const abiFunction = extractAbiFunction(BAppABI, "getSlashableBalance");

export const getGetSlashableBalanceQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "getSlashableBalance",
...
export const fetchGetSlashableBalance = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getGetSlashableBalanceQueryOptions(params));

export const useGetSlashableBalance = (
  params: AbiInputsToParams<Fn["inputs"]>,
