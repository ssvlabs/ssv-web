...
export const getMaxFeeIncrementQueryOptions = () =>
  readContractQueryOptions(config, {
    abi: BAppABI,
    chainId: getChainId(config),
    address: getSSVNetworkDetails().bAppContractAddress,
    functionName: "maxFeeIncrement",
  });
...
export const fetchMaxFeeIncrement = () =>
  queryClient.fetchQuery(getMaxFeeIncrementQueryOptions());

export const useMaxFeeIncrement = (
