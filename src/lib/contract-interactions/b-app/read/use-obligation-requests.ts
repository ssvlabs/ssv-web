...
type Fn = ExtractAbiFunction<typeof BAppABI, "obligationRequests">;
const abiFunction = extractAbiFunction(BAppABI, "obligationRequests");

export const getObligationRequestsQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "obligationRequests",
...
export const fetchObligationRequests = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getObligationRequestsQueryOptions(params));

export const useObligationRequests = (
  params: AbiInputsToParams<Fn["inputs"]>,
