...
type Fn = ExtractAbiFunction<typeof BAppABI, "obligations">;
const abiFunction = extractAbiFunction(BAppABI, "obligations");

export const getObligationsQueryOptions = (
...
export const fetchObligations = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getObligationsQueryOptions(params));
