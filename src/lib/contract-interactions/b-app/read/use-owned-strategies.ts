...
type Fn = ExtractAbiFunction<typeof BAppABI, "ownedStrategies">;
const abiFunction = extractAbiFunction(BAppABI, "ownedStrategies");

export const getOwnedStrategiesQueryOptions = (
...
export const fetchOwnedStrategies = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getOwnedStrategiesQueryOptions(params));

export const useOwnedStrategies = (
  params: AbiInputsToParams<Fn["inputs"]>,
