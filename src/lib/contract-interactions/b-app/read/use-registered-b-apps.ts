...
type Fn = ExtractAbiFunction<typeof BAppABI, "registeredBApps">;
const abiFunction = extractAbiFunction(BAppABI, "registeredBApps");

export const getRegisteredBAppsQueryOptions = (
...
export const fetchRegisteredBApps = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getRegisteredBAppsQueryOptions(params));

export const useRegisteredBApps = (
  params: AbiInputsToParams<Fn["inputs"]>,
