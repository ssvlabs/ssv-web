...
type Fn = ExtractAbiFunction<typeof BAppABI, "slashingFund">;
const abiFunction = extractAbiFunction(BAppABI, "slashingFund");

export const getSlashingFundQueryOptions = (
...
export const fetchSlashingFund = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getSlashingFundQueryOptions(params));

export const useSlashingFund = (
  params: AbiInputsToParams<Fn["inputs"]>,
