...
type Fn = ExtractAbiFunction<typeof BAppABI, "strategies">;
const abiFunction = extractAbiFunction(BAppABI, "strategies");

export const getStrategiesQueryOptions = (
...
export const fetchStrategies = (params: AbiInputsToParams<Fn["inputs"]>) =>
  queryClient.fetchQuery(getStrategiesQueryOptions(params));
