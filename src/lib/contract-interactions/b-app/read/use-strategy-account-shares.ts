...
type Fn = ExtractAbiFunction<typeof BAppABI, "strategyAccountShares">;
const abiFunction = extractAbiFunction(BAppABI, "strategyAccountShares");

export const getStrategyAccountSharesQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "strategyAccountShares",
...
export const fetchStrategyAccountShares = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getStrategyAccountSharesQueryOptions(params));

export const useStrategyAccountShares = (
  params: AbiInputsToParams<Fn["inputs"]>,
