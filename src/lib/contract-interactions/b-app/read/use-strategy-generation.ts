...
type Fn = ExtractAbiFunction<typeof BAppABI, "strategyGeneration">;
const abiFunction = extractAbiFunction(BAppABI, "strategyGeneration");

export const getStrategyGenerationQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "strategyGeneration",
...
export const fetchStrategyGeneration = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getStrategyGenerationQueryOptions(params));
