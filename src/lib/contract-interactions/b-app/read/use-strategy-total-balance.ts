...
type Fn = ExtractAbiFunction<typeof BAppABI, "strategyTotalBalance">;
const abiFunction = extractAbiFunction(BAppABI, "strategyTotalBalance");

export const getStrategyTotalBalanceQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "strategyTotalBalance",
...
export const fetchStrategyTotalBalance = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getStrategyTotalBalanceQueryOptions(params));

export const useStrategyTotalBalance = (
  params: AbiInputsToParams<Fn["inputs"]>,
