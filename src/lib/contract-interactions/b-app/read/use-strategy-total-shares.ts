...
type Fn = ExtractAbiFunction<typeof BAppABI, "strategyTotalShares">;
const abiFunction = extractAbiFunction(BAppABI, "strategyTotalShares");

export const getStrategyTotalSharesQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "strategyTotalShares",
...
export const fetchStrategyTotalShares = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getStrategyTotalSharesQueryOptions(params));

export const useStrategyTotalShares = (
  params: AbiInputsToParams<Fn["inputs"]>,
