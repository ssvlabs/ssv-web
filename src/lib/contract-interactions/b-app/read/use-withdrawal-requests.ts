...
type Fn = ExtractAbiFunction<typeof BAppABI, "withdrawalRequests">;
const abiFunction = extractAbiFunction(BAppABI, "withdrawalRequests");

export const getWithdrawalRequestsQueryOptions = (
...
export const fetchWithdrawalRequests = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getWithdrawalRequestsQueryOptions(params));
