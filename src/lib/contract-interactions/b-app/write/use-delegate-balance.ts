...
type Fn = ExtractAbiFunction<typeof BAppABI, "delegateBalance">;
const abiFunction = extractAbiFunction(BAppABI, "delegateBalance");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useDelegateBalance = () => {
