...
type Fn = ExtractAbiFunction<typeof BAppABI, "finalizeUpdateObligation">;
const abiFunction = extractAbiFunction(BAppABI, "finalizeUpdateObligation");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useFinalizeUpdateObligation = () => {
  const { bAppContractAddress } = useSSVNetworkDetails();

  const wait = useWaitForTransactionReceipt([
    "useFinalizeUpdateObligation",
    bAppContractAddress,
  ]);
      ...
      .writeContractAsync(
        {
          ...
          functionName: "finalizeUpdateObligation",
