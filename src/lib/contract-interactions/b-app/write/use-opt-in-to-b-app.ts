...
type Fn = ExtractAbiFunction<typeof BAppABI, "optInToBApp">;
const abiFunction = extractAbiFunction(BAppABI, "optInToBApp");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useOptInToBApp = () => {
