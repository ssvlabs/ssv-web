...
type Fn = ExtractAbiFunction<typeof BAppABI, "proposeFeeUpdate">;
const abiFunction = extractAbiFunction(BAppABI, "proposeFeeUpdate");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useProposeFeeUpdate = () => {
