...
type Fn = ExtractAbiFunction<typeof BAppABI, "registerBApp">;
const abiFunction = extractAbiFunction(BAppABI, "registerBApp");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useRegisterBApp = () => {
