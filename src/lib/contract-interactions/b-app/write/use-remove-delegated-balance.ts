...
type Fn = ExtractAbiFunction<typeof BAppABI, "removeDelegatedBalance">;
const abiFunction = extractAbiFunction(BAppABI, "removeDelegatedBalance");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useRemoveDelegatedBalance = () => {
  const { bAppContractAddress } = useSSVNetworkDetails();

  const wait = useWaitForTransactionReceipt([
    "useRemoveDelegatedBalance",
    bAppContractAddress,
  ]);
      ...
      .writeContractAsync(
        {
          ...
          functionName: "removeDelegatedBalance",
