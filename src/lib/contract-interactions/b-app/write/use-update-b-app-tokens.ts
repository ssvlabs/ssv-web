...
type Fn = ExtractAbiFunction<typeof BAppABI, "updateBAppTokens">;
const abiFunction = extractAbiFunction(BAppABI, "updateBAppTokens");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useUpdateBAppTokens = () => {
