...
type Fn = ExtractAbiFunction<typeof BAppABI, "updateDelegatedBalance">;
const abiFunction = extractAbiFunction(BAppABI, "updateDelegatedBalance");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useUpdateDelegatedBalance = () => {
  const { bAppContractAddress } = useSSVNetworkDetails();

  const wait = useWaitForTransactionReceipt([
    "useUpdateDelegatedBalance",
    bAppContractAddress,
  ]);
      ...
      .writeContractAsync(
        {
          ...
          functionName: "updateDelegatedBalance",
