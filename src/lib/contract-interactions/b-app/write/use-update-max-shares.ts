...
type Fn = ExtractAbiFunction<typeof BAppABI, "updateMaxShares">;
const abiFunction = extractAbiFunction(BAppABI, "updateMaxShares");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useUpdateMaxShares = () => {
