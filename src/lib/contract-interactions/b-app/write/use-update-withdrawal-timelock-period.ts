...
type Fn = ExtractAbiFunction<typeof BAppABI, "updateWithdrawalTimelockPeriod">;
    ...
    return mutation.writeContractAsync(
      {
        ...
        functionName: "updateWithdrawalTimelockPeriod",
