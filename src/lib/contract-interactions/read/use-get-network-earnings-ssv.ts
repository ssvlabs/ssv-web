...
export const getGetNetworkEarningsSSVQueryOptions = () =>
  readContractQueryOptions(config, {
    abi: MainnetV4GetterABI,
    chainId: getChainId(config),
    address: getSSVNetworkDetails().getterContractAddress,
    functionName: "getNetworkEarningsSSV",
  });
...
export const fetchGetNetworkEarningsSSV = () =>
  queryClient.fetchQuery(getGetNetworkEarningsSSVQueryOptions());

export const useGetNetworkEarningsSSV = (
