...
type Fn = ExtractAbiFunction<typeof GetterABI, "getOperatorEarningsSSV">;
const abiFunction = extractAbiFunction(GetterABI, "getOperatorEarningsSSV");

export const getGetOperatorEarningsSSVQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "getOperatorEarningsSSV",
    args: paramsToArray({ params, abiFunction }),
  });

type QueryOptions = UseReadContractParameters<
  typeof GetterABI,
  "getOperatorEarningsSSV"
>["query"];

export const fetchGetOperatorEarningsSSV = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getGetOperatorEarningsSSVQueryOptions(params));

export const useGetOperatorEarningsSSV = (
  params: AbiInputsToParams<Fn["inputs"]>,
