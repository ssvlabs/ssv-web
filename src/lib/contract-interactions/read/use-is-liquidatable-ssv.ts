...
type Fn = ExtractAbiFunction<typeof MainnetV4GetterABI, "isLiquidatableSSV">;
const abiFunction = extractAbiFunction(MainnetV4GetterABI, "isLiquidatableSSV");

export const getIsLiquidatableSSVQueryOptions = (
  ...
  readContractQueryOptions(config, {
    ...
    functionName: "isLiquidatableSSV",
...
export const fetchIsLiquidatableSSV = (
  params: AbiInputsToParams<Fn["inputs"]>,
) => queryClient.fetchQuery(getIsLiquidatableSSVQueryOptions(params));

export const useIsLiquidatableSSV = (
  params: AbiInputsToParams<Fn["inputs"]>,
