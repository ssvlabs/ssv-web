...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "liquidateSSV">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "liquidateSSV");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useLiquidateSSV = () => {
