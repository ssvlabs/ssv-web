...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "replaceOracle">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "replaceOracle");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useReplaceOracle = () => {
