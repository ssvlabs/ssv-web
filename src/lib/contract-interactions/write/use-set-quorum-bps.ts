...
type Fn = ExtractAbiFunction<typeof MainnetV4SetterABI, "setQuorumBps">;
const abiFunction = extractAbiFunction(MainnetV4SetterABI, "setQuorumBps");
// type State = "idle" | "confirming" | "mining" | "mined" | "error";

export const useSetQuorumBps = () => {
